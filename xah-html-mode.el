...
("address" "<address>▮</address>" xah-html--ahf)
("applet" "<applet>▮</applet>" xah-html--ahf)
("area" "<area>▮</area>" xah-html--ahf)
("article" "<article>▮</article>" xah-html--ahf)
("aside" "<aside>▮</aside>" xah-html--ahf)
("audio" "<audio>▮</audio>" xah-html--ahf)
("b" "<b>▮</b>" xah-html--ahf)
("base" "<base>▮</base>" xah-html--ahf)
...
("body" "<body>▮</body>" xah-html--ahf)
("br" "<br>▮</br>" xah-html--ahf)
("button" "<button>▮</button>" xah-html--ahf)
("canvas" "<canvas>▮</canvas>" xah-html--ahf)
("caption" "<caption>▮</caption>" xah-html--ahf)
("cite" "<cite>▮</cite>" xah-html--ahf)
("code" "<code>▮</code>" xah-html--ahf)
("col" "<col>▮</col>" xah-html--ahf)
("colgroup" "<colgroup>▮</colgroup>" xah-html--ahf)
("command" "<command>▮</command>" xah-html--ahf)
...
("embed" "<embed>▮</embed>" xah-html--ahf)
...
("head" "<head>▮</head>" xah-html--ahf)
("header" "<header>▮</header>" xah-html--ahf)
("hr" "<hr>▮</hr>" xah-html--ahf)
("html" "<html>▮</html>" xah-html--ahf)
("i" "<i>▮</i>" xah-html--ahf)
("iframe" "<iframe>▮</iframe>" xah-html--ahf)
("img" "<img>▮</img>" xah-html--ahf)
("input" "<input>▮</input>" xah-html--ahf)
("ins" "<ins>▮</ins>" xah-html--ahf)
("kbd" "<kbd>▮</kbd>" xah-html--ahf)
("keygen" "<keygen>▮</keygen>" xah-html--ahf)
("label" "<label>▮</label>" xah-html--ahf)
("legend" "<legend>▮</legend>" xah-html--ahf)
("li" "<li>▮</li>" xah-html--ahf)
("link" "<link>▮</link>" xah-html--ahf)
("main" "<main>▮</main>" xah-html--ahf)
("map" "<map>▮</map>" xah-html--ahf)
("mark" "<mark>▮</mark>" xah-html--ahf)
("menu" "<menu>▮</menu>" xah-html--ahf)
("meta" "<meta>▮</meta>" xah-html--ahf)
("meter" "<meter>▮</meter>" xah-html--ahf)
("nav" "<nav>▮</nav>" xah-html--ahf)
("noscript" "<noscript>▮</noscript>" xah-html--ahf)
("object" "<object>▮</object>" xah-html--ahf)
("ol" "<ol>▮</ol>" xah-html--ahf)
("optgroup" "<optgroup>▮</optgroup>" xah-html--ahf)
("option" "<option>▮</option>" xah-html--ahf)
("output" "<output>▮</output>" xah-html--ahf)
("p" "<p>▮</p>" xah-html--ahf)
("param" "<param>▮</param>" xah-html--ahf)
("pre" "<pre>▮</pre>" xah-html--ahf)
("progress" "<progress>▮</progress>" xah-html--ahf)
("q" "<q>▮</q>" xah-html--ahf)
...
("script" "<script>▮</script>" xah-html--ahf)
("section" "<section>▮</section>" xah-html--ahf)
("select" "<select>▮</select>" xah-html--ahf)
("small" "<small>▮</small>" xah-html--ahf)
("source" "<source>▮</source>" xah-html--ahf)
("span" "<span>▮</span>" xah-html--ahf)
("strong" "<strong>▮</strong>" xah-html--ahf)
("style" "<style>▮</style>" xah-html--ahf)
("sub" "<sub>▮</sub>" xah-html--ahf)
("summary" "<summary>▮</summary>" xah-html--ahf)
...
("time" "<time>▮</time>" xah-html--ahf)
("title" "<title>▮</title>" xah-html--ahf)
("tr" "<tr>▮</tr>" xah-html--ahf)
("u" "<u>▮</u>" xah-html--ahf)
("ul" "<ul>▮</ul>" xah-html--ahf)
("var" "<var>▮</var>" xah-html--ahf)
("video" "<video>▮</video>" xah-html--ahf)
